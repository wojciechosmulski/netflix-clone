...
const InfoModal: FC<InfoModalProps> = ({
  ...
  return <div
  className='z-50 transition duration-300 bg-black/80 flex justify-center items-center overflow-x-hidden
  overflow-y-auto fixed inset-0'>
    <div className='relative w-auto xm-auto max-w-3xl rounded-md overflow-hidden'>
